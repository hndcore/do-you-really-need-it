...
const CoverSection: React.FC = () => {
  return (
    <section className="flex min-h-full flex-col justify-between bg-paper px-[6vw] py-[6vh]">
      <div>
        <p className="mb-[2.5vh] text-xs uppercase tracking-[0.14em] text-earth">
        ...
        <p className="mt-[2.5vh] max-w-[460px] text-[clamp(16px,1.2vw,20px)] font-light leading-[1.65] text-clay">
          Transform every purchase into a measurement of your most precious
          resource: <span className="font-bold">time</span>. Reflection is the antidote to impulse.
        </p>
      </div>

      <div className="mt-12 border-t border-mist pt-[2.5vh]">
        <p className="mb-5 text-xs uppercase tracking-[0.14em] text-earth">
        ...
        <div className="flex flex-col gap-2.5">
          {examples.map((example) => (
            <div
              key={example.label}
              className="flex flex-wrap items-center gap-3 text-sm text-earth"
            >
